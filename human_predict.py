...
def predict(trained_model, iteration, human_accuracy):
    ...
    for i in range(len(dataset)):
        ...
        for x in range(len(probs)):
            ...
            if probs[x] <= 0.4:
                is_masked = 1
                detected_box = [name_of_object, probs[x], current_label, is_masked]
            else:
                is_masked = 0
                detected_box = [name_of_object, probs[x], current_label, is_masked]
            ...
            for each_object in all_labels:
                ...
                writer.addObject(each_object[0], each_object[2][0], each_object[2][1], each_object[2][2],
                                 each_object[2][3], each_object[3])
